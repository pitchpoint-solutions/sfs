...
public class TransientContainer extends Container<TransientContainer> {
    ...
    public static TransientContainer fromSfsRequest(PersistentAccount persistentAccount, SfsRequest httpServerRequest) {
        ...
        return new TransientContainer(persistentAccount, objectPath.containerPath().get())
                .merge(httpServerRequest)
                .setOwnerGuid(null);
    }

    public TransientContainer(PersistentAccount persistentAccount, String id) {
