...
public class PersistServiceDef implements Func1<TransientServiceDef, Observable<Optional<PersistentServiceDef>>> {

    private static final Logger LOGGER = getLogger(PersistServiceDef.class);
    private final VertxContext<Server> vertxContext;

    private final long ttl;

    public PersistServiceDef(VertxContext<Server> vertxContext, long ttl) {
