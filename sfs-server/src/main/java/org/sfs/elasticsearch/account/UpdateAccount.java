...
public class UpdateAccount implements Func1<PersistentAccount, Observable<Optional<PersistentAccount>>> {

    private static final Logger LOGGER = getLogger(UpdateAccount.class);
    private final VertxContext<Server> vertxContext;

    public UpdateAccount(VertxContext<Server> vertxContext) {
