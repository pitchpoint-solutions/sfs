...
public class ValidateHeaderIsBase16LowercaseEncoded implements Func1<SfsRequest, SfsRequest> {


    private final String headerName;

    public ValidateHeaderIsBase16LowercaseEncoded(String headerName) {
