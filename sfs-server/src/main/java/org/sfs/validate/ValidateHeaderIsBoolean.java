...
public class ValidateHeaderIsBoolean implements Func1<SfsRequest, SfsRequest> {


    private final String headerName;

    public ValidateHeaderIsBoolean(String headerName) {
        ...
        if (value != null) {
            if (!"true".equalsIgnoreCase(value) && !"false".equalsIgnoreCase(value)) {
                JsonObject jsonObject = new JsonObject()
                        .put("message", format("%s must \"true\" or \"false\"", headerName));
