...
public class ValidatePersistentAccountExists implements Func1<Optional<PersistentAccount>, PersistentAccount> {

    @Override
    public PersistentAccount call(Optional<PersistentAccount> account) {
