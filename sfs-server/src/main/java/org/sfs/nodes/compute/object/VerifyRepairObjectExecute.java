...
public class VerifyRepairObjectExecute implements Handler<SfsRequest> {
    ...
    public void handle(final SfsRequest httpServerRequest) {
        ...
        Defer.aVoid()
                ...
                .flatMap(objectPath -> {
                    ...
                    return masterNode.executeJob(Jobs.ID.VERIFY_REPAIR_OBJECT, params, timeout, TimeUnit.MILLISECONDS);
                })
                .single()
