...
public class VerifyRepairMasterKeys implements Handler<SfsRequest> {
    ...
    public void handle(final SfsRequest httpServerRequest) {
        ...
        Defer.aVoid()
                ...
                .flatMap(aVoid -> {
                    ...
                    return masterNode.executeJob(Jobs.ID.REPAIR_MASTER_KEYS, params, timeout, TimeUnit.MILLISECONDS);
                })
                .single()
