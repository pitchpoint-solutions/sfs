...
public class VerifyRepairAllContainersStop implements Handler<SfsRequest> {
    ...
    public void handle(final SfsRequest httpServerRequest) {
        ...
        Defer.aVoid()
                ...
                .flatMap(aVoid -> {
                    ...
                    return masterNode.stopJob(Jobs.ID.VERIFY_REPAIR_ALL_CONTAINERS_OBJECTS, timeout, TimeUnit.MILLISECONDS);
                })
                .single()
