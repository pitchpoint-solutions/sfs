...
public class VerifyRepairContainerWait implements Handler<SfsRequest> {
    ...
    public void handle(final SfsRequest httpServerRequest) {
        ...
        Defer.aVoid()
                ...
                .flatMap(objectPath -> {
                    ...
                    return masterNode.waitForJob(Jobs.ID.VERIFY_REPAIR_CONTAINER_OBJECTS, timeout, TimeUnit.MILLISECONDS);
                })
                .single()
