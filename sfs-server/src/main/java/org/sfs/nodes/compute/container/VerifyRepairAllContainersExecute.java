...
public class VerifyRepairAllContainersExecute implements Handler<SfsRequest> {
    ...
    public void handle(final SfsRequest httpServerRequest) {
        ...
        Defer.aVoid()
                ...
                .flatMap(aVoid -> {
                    ...
                    return masterNode.executeJob(Jobs.ID.VERIFY_REPAIR_ALL_CONTAINERS_OBJECTS, params, timeout, TimeUnit.MILLISECONDS);
                })
                .single()
