...
public class AckFile implements Func1<Long, Observable<Long>> {
    private final TestContext testContext;
    private final SfsVertx vertx;
    private final VolumeV1 sfsData;

    public AckFile(TestContext testContext, SfsVertx vertx, VolumeV1 sfsData) {
    ...
    public Observable<Long> call(final Long position) {
        return sfsData.acknowledge(vertx, position)
