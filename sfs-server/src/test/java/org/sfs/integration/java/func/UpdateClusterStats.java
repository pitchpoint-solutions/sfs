...
public class UpdateClusterStats implements Func1<Void, Observable<HttpClientResponse>> {
    ...
    public UpdateClusterStats(HttpClient httpClient, AuthorizationFactory.Producer auth) {
    ...
    public Observable<HttpClientResponse> call(Void aVoid) {
        return auth.toHttpAuthorization()
                .flatMap(s -> {
                    ...
                    urlBuilder = urlBuilder.append("/admin/001/updateclusterstats");
