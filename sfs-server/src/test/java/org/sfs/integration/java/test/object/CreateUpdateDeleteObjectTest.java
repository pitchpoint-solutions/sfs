...
public class CreateUpdateDeleteObjectTest extends BaseTestVerticle {
    ...
    public void testDynamicLargeLargeUpload(TestContext context) throws IOException {
        runOnServerContext(context, () -> {
            ...
            System.out.println("Sent Bytes 1 Are: " + BaseEncoding.base64().encode(Files.readAllBytes(tempFile1)));
            System.out.println("Sent Bytes 2 Are: " + BaseEncoding.base64().encode(Files.readAllBytes(tempFile2)));
            System.out.println("Sent Bytes 3 Are: " + BaseEncoding.base64().encode(Files.readAllBytes(tempFile3)));
