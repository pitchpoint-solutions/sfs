...
public class PostContainer implements Func1<Void, Observable<HttpClientResponse>> {
    ...
    public PostContainer(HttpClient httpClient, String accountName, String containerName, Producer auth) {
        this(httpClient, accountName, containerName, auth, create());
    }

    public PostContainer setHeader(String name, String value) {
        headers.removeAll(name);
        headers.put(name, value);
        return this;
    }

    public PostContainer setHeader(String name, String value, String... values) {
        headers.removeAll(name);
        headers.put(name, value);
        for (String v : values) {
            headers.put(name, v);
