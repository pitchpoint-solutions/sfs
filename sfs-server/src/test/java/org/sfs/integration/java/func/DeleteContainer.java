...
public class DeleteContainer implements Func1<Void, Observable<HttpClientResponse>> {

    private static final Logger LOGGER = getLogger(DeleteContainer.class);
    ...
    public DeleteContainer(HttpClient httpClient, String accountName, String containerName, Producer auth) {
        ...
        return auth.toHttpAuthorization()
                .flatMap(new Func1<String, Observable<HttpClientResponse>>() {
                    ...
                    public Observable<HttpClientResponse> call(String s) {
                        ...
                        urlBuilder = urlBuilder.append("/openstackswift001/" + accountName + "/" + containerName);
