...
public class ContainerListingTest extends BaseTestVerticle {
    ...
    public void testListPrefixObjects(TestContext context) {
        ...
        prepareContainer(context)
                ...
                .flatMap(new PutObject(HTTP_CLIENT, accountName, containerName, objectName + "/3", authNonAdmin, data2)
                        .setHeader(CONTENT_TYPE, PLAIN_TEXT_UTF_8.toString()))
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new PutObject(HTTP_CLIENT, accountName, containerName, objectName + "/3/1", authNonAdmin, data1))
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new PutObject(HTTP_CLIENT, accountName, containerName, objectName + "/3/2", authNonAdmin, data0))
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new RefreshIndex(HTTP_CLIENT, authAdmin))
                .flatMap(new GetContainer(HTTP_CLIENT, accountName, containerName, authNonAdmin)
                        .setMediaTypes(JSON_UTF_8)
    ...
    public void testListDelimiterObjects(TestContext context) {
        ...
        prepareContainer(context)
                ...
                // put three objects then list and assert
                .flatMap(new PutObject(HTTP_CLIENT, accountName, containerName, "photos/animals/cats/persian.jpg", authNonAdmin, new byte[]{}))
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new PutObject(HTTP_CLIENT, accountName, containerName, "photos/animals/cats/siamese.jpg", authNonAdmin, new byte[]{}))
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new PutObject(HTTP_CLIENT, accountName, containerName, "photos/animals/dogs/corgi.jpg", authNonAdmin, new byte[]{}))
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new PutObject(HTTP_CLIENT, accountName, containerName, "photos/animals/dogs/poodle.jpg", authNonAdmin, new byte[]{}))
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new PutObject(HTTP_CLIENT, accountName, containerName, "photos/animals/dogs/terrier.jpg", authNonAdmin, new byte[]{}))
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new PutObject(HTTP_CLIENT, accountName, containerName, "photos/me.jpg", authNonAdmin, new byte[]{}))
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new PutObject(HTTP_CLIENT, accountName, containerName, "photos/plants/fern.jpg", authNonAdmin, new byte[]{}))
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new PutObject(HTTP_CLIENT, accountName, containerName, "photos/plants/rose.jpg", authNonAdmin, new byte[]{}))
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new PutObject(HTTP_CLIENT, accountName, containerName, "photos2/plants/rose.jpg", authNonAdmin, new byte[]{}))
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new RefreshIndex(HTTP_CLIENT, authAdmin))
                .flatMap(new GetContainer(HTTP_CLIENT, accountName, containerName, authNonAdmin)
                        .setMediaTypes(JSON_UTF_8)
    ...
    public void testEmptyContainer(TestContext context) {
        ...
        just((Void) null)
                ...
                .map(new ToVoid<HttpClientResponse>())
                .flatMap(new RefreshIndex(HTTP_CLIENT, authAdmin))
                .flatMap(new GetContainer(HTTP_CLIENT, accountName, containerName, auth)
                        .setMediaTypes(JSON_UTF_8))
                .map(new HttpClientResponseHeaderLogger())
                .map(new AssertHttpClientResponseStatusCode(context, HTTP_OK))
                .flatMap(new HttpClientResponseBodyBuffer())
