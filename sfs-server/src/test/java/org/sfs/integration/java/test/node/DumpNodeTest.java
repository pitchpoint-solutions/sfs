...
import org.sfs.integration.java.func.DumpNode;
...
public class DumpNodeTest extends BaseTestVerticle {
    ...
    public void test(TestContext context) throws IOException {
        ...
        prepareContainer(context)
                ...
                .flatMap(new DumpNode(HTTP_CLIENT, authAdmin, tempDirectory))
                .map(new HttpClientResponseHeaderLogger())
